  ...
  const services = [
    {
      ...
      price: 14699,
      originalPrice: 20999,
      description: "Complete hardware & software diagnostics and repair",
      image: "https://res.cloudinary.com/urbanclap/image/upload/t_high_res_template,q_auto:low,f_auto/w_1232,dpr_1,fl_progressive:steep,q_auto:low,f_auto,c_limit/images/supply/customer-app-supply/1755788146393-1b44be.jpeg",
      fullWidthImage: true
    },
    {
      name: "Laptop checkup",
      ...
      price: 11499,
      originalPrice: 18999,
      description: "Basic diagnostics and minor repairs for common issues",
      image: "https://res.cloudinary.com/urbanclap/image/upload/t_high_res_template,q_auto:low,f_auto/w_520,dpr_1,fl_progressive:steep,q_auto:low,f_auto,c_limit/images/supply/customer-app-supply/1745306988460-6b7ace.jpeg"
    },
    {
      name: "Native M2 Pro",
      rating: 4.82,
      ...
      price: 18699,
      originalPrice: 26999,
      description: "Advanced repair including motherboard & chip level service",
      image: "https://res.cloudinary.com/urbanclap/image/upload/t_high_res_template,q_auto:low,f_auto/w_128,dpr_1,fl_progressive:steep,q_auto:low,f_auto,c_limit/images/supply/customer-app-supply/1765195701521-d34adc.jpeg"
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="w-full lg:w-64 flex-shrink-0">
            <div>
              <h1 className="text-3xl lg:text-4xl font-semibold text-gray-900 mb-4">Laptop</h1>
              ...
              <div className="flex items-center gap-2 mb-4 p-3 border border-gray-200 rounded-lg">
                <div className="w-6 h-6 flex items-center justify-center flex-shrink-0">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 2L3 7v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V7l-9-5z" stroke="#0F0F0F" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
                    <path d="M9 12l2 2 4-4" stroke="#0F0F0F" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </div>
                <span className="text-sm text-gray-700">Up to 180 days warranty</span>
              </div>
              
              <button className="w-full lg:w-auto bg-purple-600 hover:bg-purple-700 text-white font-semibold py-2 px-3 rounded-lg transition-colors">
                View Services
              </button>
            </div>
          </div>
                ...
                {services.map((service, idx) => (
                  <div key={idx} className="p-6">
                    {service.fullWidthImage && (
                      <div className="w-full h-58 bg-gray-100 rounded-lg overflow-hidden mb-4">
                        <img
                          src={service.image}
                          alt={service.name}
                    ...
                    <div className="flex flex-col md:flex-row gap-6 justify-between items-start">
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <span className="text-xs text-gray-700">{service.rating} ({service.reviews} reviews)</span>
                        </div>
                        <p className="text-sm text-gray-600 mb-2">{service.description}</p>
                        <div className="">
                          <span className="text-xs font-bold text-gray-900">₹{service.price.toLocaleString()}</span>
                          <span className="text-xs text-gray-500 line-through ml-2">₹{service.originalPrice.toLocaleString()}</span>
                        </div>
                      ...
                      {!service.fullWidthImage ? (
                        <div className="flex flex-col items-center gap-2">
                          ...
                          <div className="flex justify-center">
                            <button className="bg-white border-2 border-purple-600 text-purple-600 font-semibold py-1.5 px-8 rounded-lg hover:bg-purple-50 transition-colors text-sm md:mt-[-25px]">
                              Add
                            </button>
                          </div>
                        </div>
                        ...
                        <div className="flex justify-center">
                          <button className="bg-white border-2 border-purple-600 text-purple-600 font-semibold py-1.5 px-8 rounded-lg hover:bg-purple-50 transition-colors text-sm">
                            Add
                          </button>
                        </div>
                      )}
              ...
              <div className="rounded-lg border border-gray-200 p-4">
                <div className="flex items-start gap-3 mb-3">
                  <div className="w-10 h-10 bg-green-100 rounded-full flex items-center justify-center flex-shrink-0">
                    <svg width="100%" height="100%" viewBox="0 0 24 24" fill="#05945B" xmlns="http://www.w3.org/2000/svg"><path d="M7.75 8.5a.75.75 0 111.5 0 .75.75 0 01-1.5 0zM14.75 15.5a.75.75 0 111.5 0 .75.75 0 01-1.5 0z" fill="#05945B"></path><path fillRule="evenodd" clipRule="evenodd" d="M2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10S2 17.523 2 12zm6.5-5.75a2.25 2.25 0 100 4.5 2.25 2.25 0 000-4.5zm7 7a2.25 2.25 0 100 4.5 2.25 2.25 0 000-4.5zm-8.93 3.12l9.9-9.9 1.06 1.06-9.9 9.9-1.06-1.06z" fill="#05945B"></path></svg>
                  </div>
                  <div className="flex-1">
